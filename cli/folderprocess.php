...
list($options, $unrecognized) = cli_get_params(array('folderpath'=>null, 'silent'=>false, 'help'=>false),
                                               array('f'=>'folderpath', 's'=>'silent'));
...
if ($options['help']) {
    $help =
    "LMB folder import CLI tool.
Process a folder using the LMB plugin.

Options:
-f, --folderpath        Path to the folder to process. Use config setting if not specified.
-h, --help              Print out this help
-s, --silent            Don't print logging output to stdout.


Example:
\$sudo -u www-data /usr/bin/php enrol/lmb/cli/folderprocess.php
";
...
$enrol->process_folder($folderpath);
