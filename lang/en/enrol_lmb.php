...
//$string['hhformat'] = '(HH)';
//$string['minutesformat'] = '(In minutes)';
...
//$string['bannercron'] = 'Import automatically during cron';
//$string['bannercrontime'] = 'Import during the first cron job after';
...
$string['makeenrollable'] = 'Make new courses enrollable';
...
$string['makeenrollablehelp'] = 'This sets wether new courses are enrollable or not.';
...
$string['enrolname'] = 'Luminis Message Broker';
